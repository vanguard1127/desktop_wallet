export default {
  COMMON: {
    ...
    ADDRESS: 'Address',
    ALL: 'All',
    APP_NAME: 'Infinity Desktop Wallet',
    APP_NAME_SHORT: 'INFINITY Desktop',
  ...
  INTRODUCTION: {
    ...
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE: 'Now, armed with the knowledge of how important it is to keep your passphrases safe, you are ready to claim your financial autonomy with the INFINITY Desktop Wallet.',
      SUPPORT: 'INFINITY is an open-source ecosystem and if you need assistance, the INFINITY community and team is here to help. Create a post on reddit.infinitysolutions.io, or join the real-time chat system at slack.infinitysolutions.io.',
      CONCLUSION: 'Everyone here on the INFINITY.io team hopes you enjoy using the INFINITY Desktop Wallet to participate in the blockchain revolution!'
    }
  },
  ...
  LEDGER: {
    NEEDS_UPDATE: 'Ledger update available! Please update the INFINITY app via Ledger Live to send transactions on this network'
  },
  ...
  MODAL_NETWORK: {
    ...
    PLACEHOLDER: {
      EXPLORER: 'http://explorer.infinitysolutions.io',
  ...
  PAGES: {
    ...
    PLUGIN_MANAGER: {
      ...
      GRANTS: 'Funded by INFINITY Grants',
      MENU: 'Menu',
      BANNER: {
      ...
      DISCLAIMER: '<b>Disclaimer:</b> The availability of this plugin in the INFINITY Desktop Wallet does not mean that either infinitysolutions.io or ARK SCIC is directly involved in the development or affiliated with the developer providing this plugin. By installing it on your wallet, you assume every responsibility.',
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Purchase {ticker} directly within INFINITY Desktop Wallet with our Changelly integration',
